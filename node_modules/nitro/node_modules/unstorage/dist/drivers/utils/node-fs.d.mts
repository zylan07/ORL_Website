...
export declare function readFile(path: string, encoding?: BufferEncoding): Promise<string | Buffer | null>;
export declare function stat(path: string): Promise<import("node:fs").Stats | null>;
export declare function unlink(path: string): Promise<void | null>;
