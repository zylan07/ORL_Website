...
*/
var buildRefreshAnchorStatement = template.statement(`export function %%anchorName%%() { return null }`, { syntacticPlaceholders: true });
function createReactRefreshIgnoredRouteExportsPlugin() {
	return {
		...
		onAddHmr(ctx) {
			...
			ctx.programPath.pushContainer("body", buildReactRefreshIgnoredRouteExportsStatements({ moduleId: t.stringLiteral(ctx.opts.id) }));
...
//# sourceMappingURL=react-refresh-ignored-route-exports.js.map